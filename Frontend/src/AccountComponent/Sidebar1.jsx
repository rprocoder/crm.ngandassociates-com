...
import { unSetUserToken2 } from '../features/authSlice';
import { removeToken2 } from '../services/LocalStorageService';
...
const Sidebar1 = () => {
    const handleLogout = () => {
        ...
        dispatch(unSetUserToken2({ access_token2: null }))
        removeToken2()
        navigate('/')
    }
    ...
    return (
        <div>
            <div id="wrapper">
                <div className="topbar">
                    <div className="topbar-left">
                        <Link to="#" className="logo"><img src="assets/images/logo.png" alt="" style={{ width: "auto", height: "67px" }} /></Link>
                    </div>
            ...
            <div style={{marginTop:"100px", marginBottom:"80px", marginLeft:"1%", marginRight:"1%"}}>
            <Outlet />
            </div>
            <footer class="footer">
