...
const DocumentWallet = () => {
    ...
    const fetchCompanydocuments = async () => {
        const result = await axios.get(
            `http://admin.ngandassociates.com/showcompanydocument/${token}`
        );
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-sm-12">
                                <div className="page-title-box">
                                    <h4 className="page-title">Document Wallet</h4>
                        ...
                        <div className="card m-b-20">
                            <div className="row">
                                ...
                                <div className="col-lg-4" style={{width:"100px"}}>
                                    <p>Director's Photograph</p>{" "}
                                    {userwallet.map((document, index) => (
                                        <img
                                ...
                                <div className="col-lg-4" style={{width:"100px"}}>
                                    <p>Proof Of Premises(Rent Agrement)</p>{" "}
                                    {userwallet.map((document, index) => (
                                        <img
                                            src={document.rentagrement}
                                            width="100%"
                                            height="auto"
                                            alt=""
                                        />
                                ...
                                <div className="col-lg-4" style={{width:"100px"}}>
                                    <p>Photo Of Business Unit / Premises</p>{" "}
                                    {userwallet.map((document, index) => (
                                        <img
                                            src={document.photoofpremises}
                                            width="100%"
                                            height="auto"
                                            alt=""
                                        />
                                       ...
                                       <Link to="">
                                        <div className="card-body mini-stat-img">
                                            ...
                                            <div className="text-white">
                                                <p className="text-uppercase mb-3">Account Overview</h6> 
                                            </div>
                                        </div>
                                         </Link>
                                    </div>
