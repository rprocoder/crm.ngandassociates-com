...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Register An Indian Subsidiary");
...
const PersonalForm = () => {
  const [name, setName] = useState("Register An Indian Subsidiary");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Register An Indian Subsidiary</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Register An Indian Subsidiary');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const RegisterAnIndianSubsidiary = () => {
  const classes = useStyles();
