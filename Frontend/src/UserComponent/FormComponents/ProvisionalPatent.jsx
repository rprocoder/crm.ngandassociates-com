...
const BasicForm = () => {
    ...
    const [servicename, setServicename] = useState("Provisional Patent");
...
const PersonalForm = () => {
    const [name, setName] = useState("Provisional Patent");
...
const SummaryForm = () => {
    const [servicename] = useState('Provisional Patent');
    const [documents, setDocuments] = useState([]);
    let token = localStorage.getItem("access_token");
    const fetchCompanydocuments = async () => {
        const result = await axios.get(
