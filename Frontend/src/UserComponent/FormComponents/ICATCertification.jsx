...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("ICAT Certification");
...
const PersonalForm = () => {
  const [name, setName] = useState("ICAT Certification");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>ICAT Certification</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('ICAT Certification');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
