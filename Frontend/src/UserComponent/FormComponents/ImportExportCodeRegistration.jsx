...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Import Export Code Registration");
...
const PersonalForm = () => {
  const [name, setName] = useState("Import Export Code Registration");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Import Export Code Registration</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Import Export Code Registration');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const ImportExportCodeRegistration = () => {
  const classes = useStyles();
