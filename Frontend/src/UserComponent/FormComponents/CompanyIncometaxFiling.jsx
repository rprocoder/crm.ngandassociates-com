...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Company Income Tax Filing");
...
const PersonalForm = () => {
  const [name, setName] = useState("Company Incometax Filing");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Company Incometax Filing</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Company Income Tax Filing');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
export default CompanyIncometaxFiling;