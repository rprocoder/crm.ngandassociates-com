...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Proprietorship To Partnership");
...
const PersonalForm = () => {
  const [name, setName] = useState("Proprietorship To Partnership");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Proprietorship To Partnership</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Proprietorship To Partnership');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const ProprietorshipToPartnership = () => {
  const classes = useStyles();
