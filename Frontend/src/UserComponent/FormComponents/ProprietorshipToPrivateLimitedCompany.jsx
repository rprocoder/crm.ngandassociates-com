...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Proprietorship To Private Limited Company");
...
const PersonalForm = () => {
  const [name, setName] = useState("Proprietorship To Private Limited Company");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Proprietorship To Private Limited Company</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Proprietorship To Private Limited Company');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const ProprietorshipToPrivateLimitedCompany = () => {
  const classes = useStyles();
