...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Private Limited Company To LLP");
...
const PersonalForm = () => {
  const [name, setName] = useState("Private Limited Company To LLPP");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Private Limited Company To LLPP</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Private Limited Company To LLP');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const PrivateLimitedCompanyToLLP = () => {
  const classes = useStyles();
              ...
              <div className="col-sm-12">
                <div className="page-title-box">
                  <h4 className="page-title" style={{ textAlign: "center" }}>
                    Private Limited Company To LLPo
                  </h4>
