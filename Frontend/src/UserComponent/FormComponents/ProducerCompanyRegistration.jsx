...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Producer Company Registration");
...
const PersonalForm = () => {
  const [name, setName] = useState("Producer Company Registration");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Producer Company Registration</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Producer Company Registration');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
