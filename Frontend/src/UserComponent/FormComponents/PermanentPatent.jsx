...
const BasicForm = () => {
    ...
    const [servicename, setServicename] = useState("Permanent Patent");
...
const PersonalForm = () => {
    const [name, setName] = useState("Permanent Patent");
            ...
            >
                ...
                <div className="payment">
                    <div className="form-group">
                        ...
                        >
                            <option>Permanent Patent</option>
                        </select>
                    </div>
                    <div className="form-group">
...
const SummaryForm = () => {
    const [servicename] = useState('Permanent Patent');
    const [documents, setDocuments] = useState([]);
    let token = localStorage.getItem("access_token");
    const fetchCompanydocuments = async () => {
        const result = await axios.get(
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <div className="verified_d" >
                                            {documents.map((document, index) => (
                                                <img src={document.directorspancard} />
                                            ))}
                                        </div>
                                        <div className="verified_d" >
                                            {documents.map((document, index) => (
                                                <img src={document.idproof} />
                                            ))}
                                        </div>
                                        <div className="verified_d" >
                                            {documents.map((document, index) => (
                                                <img src={document.dinofdirectors} />
                                            ))}
                                        </div>
                                        <br />
                                        <br />
                                        ...
                                        <div className="verified_d" >
                                            {documents.map((document, index) => (
                                                <img src={document.residentialproof} />
                                            ))}
                                        </div>
                                        <div className="verified_d" >
                                            {documents.map((document, index) => (
                                                <img src={document.moa} />
                                            ))}
                                        </div>
                                        <div className="verified_d" >
                                            {documents.map((document, index) => (
                                                <img src={document.aoa} />
                                            ))}
                                        </div>
                                    </td>
                                    <td>
