...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Private Company To Public Company");
...
const PersonalForm = () => {
  const [name, setName] = useState("Private Company To Public Company");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Private Company To Public Company</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Private Company To Public Company');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const PrivateCompanyToPublicCompany = () => {
  const classes = useStyles();
