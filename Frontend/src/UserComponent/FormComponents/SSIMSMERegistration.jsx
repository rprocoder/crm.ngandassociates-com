...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("SSI MSME Registration");
...
const PersonalForm = () => {
  const [name, setName] = useState("SSIMSME Registration");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>SSIMSME Registration</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('SSI MSME Registration');
  let token = localStorage.getItem("access_token");
  const [documents, setDocuments] = useState([]);
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
