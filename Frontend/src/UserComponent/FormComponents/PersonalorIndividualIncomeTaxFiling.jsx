...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Personal or Individual Income Tax Filing");
...
const PersonalForm = () => {
  const [name, setName] = useState("Personal or Individual Income Tax Filing");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Personal or Individual Income Tax Filing</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Personal or Individual Income Tax Filing');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const PersonalorIndividualIncomeTaxFiling = () => {
  const classes = useStyles();
...
export default PersonalorIndividualIncomeTaxFiling;
