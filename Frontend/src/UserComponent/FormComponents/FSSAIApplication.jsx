...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("FSSAI Application");
...
const PersonalForm = () => {
  const [name, setName] = useState("FSSAI Application");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>FSSAI Application</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('FSSAI Application');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
