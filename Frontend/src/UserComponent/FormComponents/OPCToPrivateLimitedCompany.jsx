...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("OPC To Private Limited Company");
...
const PersonalForm = () => {
  const [name, setName] = useState("OPC To Private Limited Company");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>OPC To Private Limited Company</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('OPC To Private Limited Company');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const OPCToPrivateLimitedCompany = () => {
  const classes = useStyles();
