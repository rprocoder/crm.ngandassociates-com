...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Proprietorship To OPC");
...
const PersonalForm = () => {
  const [name, setName] = useState("Proprietorship To OPC");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Proprietorship To OPC</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Proprietorship To OPC');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
