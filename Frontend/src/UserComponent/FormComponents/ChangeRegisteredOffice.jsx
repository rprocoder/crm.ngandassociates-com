...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Change Registered Office");
...
const PersonalForm = () => {
  const [name, setName] = useState("Change Registered Office");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Change Registered Office</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Change Registered Office');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
