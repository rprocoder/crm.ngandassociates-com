...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("ARAI Certification");
...
const PersonalForm = () => {
  const [name, setName] = useState("ARAI Certification");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option> ARAI Certification</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename]=useState('ARAI Certification');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
export default ARAICertification;