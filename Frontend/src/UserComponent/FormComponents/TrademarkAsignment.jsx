...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Trademark Asignment");
...
const PersonalForm = () => {
  const [name, setName] = useState("Trademark Asignment");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Trademark Asignment</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Trademark Asignment');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
export default TrademarkAsignment;
