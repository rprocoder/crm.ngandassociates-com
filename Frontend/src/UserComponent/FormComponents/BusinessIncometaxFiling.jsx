...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Business Income Tax Filing");
...
const PersonalForm = () => {
  const [name, setName] = useState("Business Incometax Filing");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Business Incometax Filing</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename]=useState('Business Incometax Filing');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
export default BusinessIncometaxFiling;