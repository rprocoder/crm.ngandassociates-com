...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Change LLP Agreement");
...
const PersonalForm = () => {
  const [name, setName] = useState("Change LLP Agreement");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Change LLP Agreement</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Change LLP Agreement');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
