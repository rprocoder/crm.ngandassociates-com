...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Increase Authorised Share Capital");
...
const PersonalForm = () => {
  const [name, setName] = useState("Increase Authorised Share Capital");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Increase Authorised Share Capital</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Increase Authorised Share Capital');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const IncreaseAuthorisedShareCapital = () => {
  const classes = useStyles();
