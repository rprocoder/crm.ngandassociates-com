...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("AddorRemoveaDirector");
...
const ContactForm = () => {
  ...
  let token = localStorage.getItem("access_token");
  const [servicename, setServicename] = useState("Add or Remove a Director");
  const notify = () => {
    toast.success("upload sucessfully.", {
      position: toast.POSITION.TOP_CENTER,
      autoClose: true,
...
const PersonalForm = () => {
  const [name, setName] = useState("Add or Remove a Director");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Add or Remove a Director</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Add or Remove a Director');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
export default AddorRemoveaDirector;