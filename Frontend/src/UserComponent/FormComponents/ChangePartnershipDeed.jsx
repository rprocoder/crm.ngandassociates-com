...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Change Partnership Deed");
...
const PersonalForm = () => {
  const [name, setName] = useState("Change Partnership Deed");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Change Partnership Deed</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Change Partnership Deed');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
