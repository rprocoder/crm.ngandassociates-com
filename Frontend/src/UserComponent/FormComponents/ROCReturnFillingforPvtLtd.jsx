...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("ROC Return Filling For PvtLtd");
...
const PersonalForm = () => {
  const [name, setName] = useState("ROC Return Filling For Pvt Ltd");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>ROC Return Filling For Pvt Ltd</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('ROC Return Filling For PvtLtd');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const ROCReturnFillingforPvtLtd = () => {
  const classes = useStyles();
              ...
              <div className="col-sm-12">
                <div className="page-title-box">
                  <h4 className="page-title" style={{ textAlign: "center" }}>
                    ROC Return Filling For Pvt Ltd
                  </h4>
...
export default ROCReturnFillingforPvtLtd;
