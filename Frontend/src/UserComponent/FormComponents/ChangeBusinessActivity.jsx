...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Change Business Activity");
...
const PersonalForm = () => {
  const [name, setName] = useState("Change Business Activity");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Change Business Activity</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename]=useState('Change Business Activity');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
