...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Dissolve a Partnership Farm");
...
const PersonalForm = () => {
  const [name, setName] = useState("Dissolve a Partnership Farm");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option> Dissolve a Partnership Farm</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Dissolve a Partnership Farm');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const DissolveaPartnershipFarm = () => {
  const classes = useStyles();
...
export default DissolveaPartnershipFarm;