...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Add or Remove a Partner");
...
const PersonalForm = () => {
  const [name, setName] = useState("Add or Remove a Partner");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Add or Remove a Partner</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename]=useState('Add or Remove a Partner');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
export default AddorRemoveaPartner;