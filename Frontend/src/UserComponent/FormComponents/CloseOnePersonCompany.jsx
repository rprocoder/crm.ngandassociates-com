...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Close One Person Company");
...
const PersonalForm = () => {
  const [name, setName] = useState("Close One Person Company");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Close One Person Company</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Private Limited Company Registration');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
