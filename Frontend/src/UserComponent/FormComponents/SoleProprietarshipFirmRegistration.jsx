...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("Sole Proprietarship Firm Registration");
...
const PersonalForm = () => {
  const [name, setName] = useState("Sole Proprietarship Firm Registration");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>Sole Proprietarship Firm Registration</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('Sole Proprietarship Firm Registration');
  let token = localStorage.getItem("access_token");
  const [documents, setDocuments] = useState([]);
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
const SoleProprietarshipFirmRegistration = () => {
  const classes = useStyles();
              ...
              <div className="col-sm-12">
                <div className="page-title-box">
                  <h4 className="page-title" style={{ textAlign: "center" }}>
                    Sole Proprietarship Firm Registration
                  </h4>
...
export default SoleProprietarshipFirmRegistration;
