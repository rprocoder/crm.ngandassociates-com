...
const BasicForm = () => {
  ...
  const [servicename, setServicename] = useState("ROC Return Filling For LLP");
...
const PersonalForm = () => {
  const [name, setName] = useState("ROC Return Filling for LLP");
      ...
      >
        ...
        <div className="payment">
          <div className="form-group">
            ...
            >
              <option>ROC Return Filling for LLP</option>
            </select>
          </div>
          <div className="form-group">
...
const SummaryForm = () => {
  const [servicename] = useState('ROC Return Filling For LLP');
  const [documents, setDocuments] = useState([]);
  let token = localStorage.getItem("access_token");
  const fetchCompanydocuments = async () => {
    const result = await axios.get(
...
export default ROCReturnFillingforLLP;
